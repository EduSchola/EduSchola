    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.parent')),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.school')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_user', to='edusch_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.school')),
                ('subjects', models.ManyToManyField(to='edusch_app.course')),
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff_user', to='edusch_app.user')),
            ],
        ),
        migrations.AddField(
            model_name='parent',
            name='user',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_user', to='edusch_app.user'),
        ),
        migrations.CreateModel(
            name='Grade',
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.course')),
                ('staff', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.staff')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.student')),
            ],
        ),
        migrations.AddField(
            model_name='course',
            name='school',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.school'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.user'),
        ),
        migrations.CreateModel(
            name='Assignment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='edusch_app.course')),
            ],
        ),
    ]
